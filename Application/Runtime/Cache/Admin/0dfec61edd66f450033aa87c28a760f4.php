...
<head>
	...
	<!-- Meta, title, /erongchuang/Public/Admin/css, favicons, etc. -->
	<meta charset="utf-8">
	<title>后台管理系统</title>
...
<div id="main">
  <div class="container">
    <div class="row">
      <div id="page-logo"><img src="/erongchuang/Public/Admin/images/logo.png"></div>
    </div>
    <div class="row">
      <div class="panel">
        <div class="panel-heading">
          <div class="panel-title">艺融创后台管理系统</div>
		</div>
...
<script src="/erongchuang/Public/Admin/js/jquery.min.js"></script> 
<script src="/erongchuang/Public/Admin/js/jquery-ui.min.js"></script> 
<script src="/erongchuang/Public/Admin/js/bootstrap.min.js"></script> <!-- Theme Javascript --> 
