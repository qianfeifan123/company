...
<body>
<!-- Start: Header -->
<header class="navbar navbar-fixed-top" style="background-image: none; background-color:#5a5659;">
  <div class="pull-left"> <a class="navbar-brand" href="#">
    <div class="navbar-logo"><img src="/erongchuang/Public/Admin/images/logo.png" alt="logo" style="width:260px; margin-left:90px;"></div>
    </a> </div>
  ...
  <aside id="sidebar" class="affix">
    ...
    <div id="sidebar-menu">
      <ul class="nav sidebar-nav">
		...
		<li>
          <a href="<?php echo U("Index/class_list"); ?>"><span class="glyphicons glyphicon-list"></span><span class="sidebar-title">首&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;页</span></a>
        </li>
		<li>
          <a href="<?php echo U("Xiangmu/class_list"); ?>"><span class="glyphicons glyphicon-list"></span><span class="sidebar-title">洽谈项目</span></a>
        </li>
        <li>
          <a href="<?php echo U("Anli/class_list"); ?>"><span class="glyphicons glyphicon-list"></span><span class="sidebar-title">案例展示</span></a>
        </li>
		<li>
          <a href="<?php echo U("Fuwu/class_list"); ?>"><span class="glyphicons glyphicon-list"></span><span class="sidebar-title">服务内容</span></a>
        </li>
		<li>
          <a href="<?php echo U("Xinwen/class_list"); ?>"><span class="glyphicons glyphicon-list"></span><span class="sidebar-title">新闻中心</span></a>
        </li>
		<li>
  ...
  <!-- End: Sidebar -->  
    ...
    <section id="content">
        <div id="topbar" class="affix">
            <ol class="breadcrumb">
                <li><a href="<?php echo U("Fuwu/class_list");?>"><span class="glyphicon glyphicon-home"></span></a></li>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <div class="panel-btns pull-right margin-left">
                                    <a href="<?php echo U("Fuwu/class_list");?>"
...
<!-- End: Main -->
<link type="text/css" rel="stylesheet" href="/erongchuang/Public/Admin/baidu/themes/default/_css/umeditor.css">
<script src="/erongchuang/Public/Admin/baidu/umeditor.config.js" type="text/javascript"></script>
<script src="/erongchuang/Public/Admin/baidu/editor_api.js" type="text/javascript"></script>
<script src="/erongchuang/Public/Admin/baidu/lang/zh-cn/zh-cn.js" type="text/javascript"></script>
