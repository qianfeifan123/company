  ...
  <!-- End: Sidebar -->  
    ...
    <section id="content">
        <div id="topbar" class="affix">
            <ol class="breadcrumb">
                <li><a href="<?php echo U("Dongtai/class_list");?>"><span class="glyphicon glyphicon-home"></span></a></li>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <div class="panel-btns pull-right margin-left">
                                    <a href="<?php echo U("Dongtai/class_list");?>"
                            ...
                            <div class="panel-body">
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group">
										...
										<img src="/biye/Uploads/<?php echo ($sql["img"]); ?>" width="100px" height="100px">
