                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                      <div class="input-group"><span class="input-group-addon">内容</span>
                                            <!-- <script id="editor" name="password" type="text/plain" style="width:100%;height:500px;"><?php echo $sql["content"];?></script> -->
                                            <textarea row="10" cols="20" name="password" type="text" style="width:500px;height: 200px;"><?php echo $sql["content"];?>
                                            </textarea>
                                        </div>
                                    </div>
                                    <script>
