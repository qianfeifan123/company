...
<header class="navbar navbar-fixed-top" style="background-image: none; background-color: rgb(240, 240, 240);">
  <div class="pull-left"> <a class="navbar-brand" href="#">
    <div class="navbar-logo"><img src="/erongchuang/Public/Admin/images/logo.png" alt="logo"></div>
    </a> </div>
  ...
  <aside id="sidebar" class="affix">
    ...
    <div id="sidebar-menu">
      <ul class="nav sidebar-nav">
		...
		<li>
          <a href="<?php echo U("Xiangmu/class_list"); ?>"><span class="glyphicons glyphicon-home"></span><span class="sidebar-title">洽谈项目</span></a>
        </li>
        <li>
  ...
  <!-- End: Sidebar -->  
    ...
    <section id="content">
        <div id="topbar" class="affix">
            <ol class="breadcrumb">
                <li><a href="<?php echo U("Lianxi/class_list");?>"><span class="glyphicon glyphicon-home"></span></a></li>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <div class="panel-btns pull-right margin-left">
                                    <a href="<?php echo U("Lianxi/class_list");?>"
