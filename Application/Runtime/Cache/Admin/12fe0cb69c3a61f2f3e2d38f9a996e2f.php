  ...
  <!-- End: Sidebar -->  
    ...
    <section id="content">
        <div id="topbar" class="affix">
            <ol class="breadcrumb">
                <li><a href="<?php echo U("Company/index");?>"><span class="glyphicon glyphicon-home"></span></a></li>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">公司名</span>
                                            <input type="text" name="name" value="<?php echo $sql["name"];?>"
                                                   class="form-control">
                                        </div>
                                        ...
                                        <div class="input-group"><span class="input-group-addon">联系人</span>
                                            <input type="text" name="admin" value="<?php echo $sql["admin"];?>"
                                                   class="form-control">
                                        </div>
										<div class="input-group"><span class="input-group-addon">电话</span>
                                            <input type="text" name="tel" value="<?php echo $sql["tel"];?>"
                                                   class="form-control">
                                        </div>
										<div class="input-group"><span class="input-group-addon">邮箱</span>
                                            <input type="text" name="email" value="<?php echo $sql["email"];?>"
                                                   class="form-control">
                                        </div>
                                        <div class="input-group"><span class="input-group-addon">地址</span>
                                            <input type="text" name="address" value="<?php echo $sql["address"];?>"
                                                   class="form-control">
                                        </div>
                                        <div class="input-group"><span class="input-group-addon">qq</span>
                                            <input type="text" name="qq" value="<?php echo $sql["qq"];?>"
                                                   class="form-control">
                                        </div>
                                        <div class="input-group"><span class="input-group-addon">邮编</span>
                                            <input type="text" name="mail" value="<?php echo $sql["mail"];?>"
                                                   class="form-control">
                                        </div>
                                    </div>
