...
<head>
  ...
  <script src="/erongchuang/Public/Admin/js/js/froala_editor.min.js"></script>
  <!--[if lt IE 9]>
    <script src="../js/froala_editor_ie8.min.js"></script>
  <![endif]-->
  <script src="/erongchuang/Public/Admin/js/js/plugins/tables.min.js"></script>
  <script src="/erongchuang/Public/Admin/js/js/plugins/lists.min.js"></script>
  <script src="/erongchuang/Public/Admin/js/js/plugins/colors.min.js"></script>
  <script src="/erongchuang/Public/Admin/js/js/plugins/media_manager.min.js"></script>
  <script src="/erongchuang/Public/Admin/js/js/plugins/font_family.min.js"></script>
  <script src="/erongchuang/Public/Admin/js/js/plugins/font_size.min.js"></script>
  <script src="/erongchuang/Public/Admin/js/js/plugins/block_styles.min.js"></script>
  <script src="/erongchuang/Public/Admin/js/js/plugins/video.min.js"></script> 
</head>
  ...
  <!-- End: Sidebar -->  
    ...
    <section id="content">
        <div id="topbar" class="affix">
            <ol class="breadcrumb">
                <li><a href="<?php echo U("Xinwen/class_list");?>"><span class="glyphicon glyphicon-home"></span></a></li>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                ...
                                <div class="panel-btns pull-right margin-left">
                                    <a href="<?php echo U("Xinwen/class_list");?>"
