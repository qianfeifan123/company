...
<meta charset="utf-8" />
<title></title>
<link rel="stylesheet" type="text/css" href="/qianhai/Public/Home/css/chengyaojiameng.css" />
...
<div class="head">
   ...
   <a>首页     >    诚邀加盟    >     合作模式  </a>
	  ...
	  <ul>
	  <li><img src="/qianhai/Public/Home/images/gh.gif"/>诚邀加盟</li>
	  <li><img src="/qianhai/Public/Home/images/gh.gif"/>收益分配</li>
	  ...
	  <h3><?php echo $sql[3]['name'];?></h3>
	  <p><?php echo html_entity_decode($sql[3]['content']);?></p>
    <p><?php echo html_entity_decode($sql[4]['content']);?></p>
	  <h3><?php echo $sql[5]['name'];?></h3>
	  <p><?php echo html_entity_decode($sql[5]['content']);?></p>
    <p><?php echo html_entity_decode($sql[6]['content']);?></p>
	 <h3><?php echo $sql[7]['name'];?></h3>
	  <p><?php echo html_entity_decode($sql[7]['content']);?></p>
	  </div>  
