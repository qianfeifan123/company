...
<div class="breadBox-r">
         ...
         <span></span> <a href="<?php echo U('Home/'.$list['link'].'/id/'.$list['id']);?>" Layout="None" class="dqwz_am">核心能力</a>
            </div>
...
<div class="containers" style=" width:1000px; margin:auto;height: auto;">
        <div class="ej-cont">
            <div class="ej-cont-l noBorderR">
                <dl>
                    <dt style="width:94px;color: #fff;"><?php echo $sql['id'];?></dt> 
                </dl>
            </div>
            <div class="ej-cont-r padBotm50 paddingLR60">
                <h2><?php echo $sql['title'];?></h2><!--?xml version="1.0" encoding="utf-8" standalone="no"?-->
...
<title>
	...
	<div class="Section1">
		...
		<img class="bannerimg1" src="/erongchuang/Uploads/<?php echo $sql['img'];?>"  alt="" border="0" />
	</p>
