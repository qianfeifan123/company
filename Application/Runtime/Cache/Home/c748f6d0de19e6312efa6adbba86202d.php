...
<body>
  ...
  <div class="lx_content1">
   <div class="lx_content_tou">
      <a href="<?php echo U("Jingbianwenji/jingbianwenji");?>"><p class="dao">精编文集</p></a>
      <a href="<?php echo U("Jiaoyuzixun/jiaoyuzixun");?>"><p class="dao">教育资讯</p></a>
      <a href="<?php echo U("Xueshujiaoliu/xueshujiaoliu");?>"><p class="dao">学术交流</p></a>
	  <div class="clear"></div>
   </div>
  </div>
   <div class="jingbian">
       <div class="shiping">
	   <?php if(is_array($sql)): foreach($sql as $key=>$value): ?><div class="shiping_cong">
             <div class="shiping_cong_1">
		        <img src="/biye/Uploads/<?php echo $sql[0]['img'];?>">
				<h5 class="ti"><?php echo $sql[0]['name'];?></h5>
				<span class="zi"><?php echo html_entity_decode($sql[0]['content']);?></span>
				<span class="shijian"><?php echo date("Y-m-d",$sql[0]['times']);?></span>
             </div>
			  <div class="shiping_cong_1">
		        <img src="/biye/Uploads/<?php echo $sql[1]['img'];?>">
				<h5 class="ti"><?php echo $sql[1]['name'];?></h5>
				<span class="zi"><?php echo html_entity_decode($sql[1]['content']);?></span>
				<span class="shijian"><?php echo date("Y-m-d",$sql[1]['times']);?></span>
             </div>
			  <div class="shiping_cong_1">
		        <img src="/biye/Uploads/<?php echo $sql[2]['img'];?>">
				<h5 class="ti"><?php echo $sql[2]['name'];?></h5>
				<span class="zi"><?php echo html_entity_decode($sql[2]['content']);?></span>
				<span class="shijian"><?php echo date("Y-m-d",$sql[2]['times']);?></span>
             </div>
			 <div class="clear"></div>
