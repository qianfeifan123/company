...
<body>
  ...
  <div class="lx_content_top">
         ...
         <div class="lx_content_top_right">
		    <ul>
			   <li><?php echo html_entity_decode($sql[0]['content']);?></li>
			   <li><?php echo html_entity_decode($sql[1]['content']);?></li>
			   <li><?php echo html_entity_decode($sql[2]['content']);?></li>
			   <li><?php echo html_entity_decode($sql[3]['content']);?></li>
			   <li><?php echo html_entity_decode($sql[4]['content']);?></li>
			   <li></li>
		    </ul>
         </div>
         <div class="clear"></div>   
  ...
  <div class="lx_content_bottom">
    <div class="lx_content_bottom_left">
	    <div class="lx_content_bottom_left_box">
		    <a href="#"><img src="/biye/Uploads/<?php echo $sql[5]['img'];?>"></a>
		    <p><?php echo $sql[5]['name'];?></p>
		</div>
		 <div class="lx_content_bottom_left_box">
		    <a href="#"><img src="/biye/Uploads/<?php echo $sql[6]['img'];?>"></a>
		    <p><?php echo $sql[6]['name'];?></p>
		</div>
		 <div class="lx_content_bottom_left_box">
		    <a href="#"><img src="/biye/Uploads/<?php echo $sql[7]['img'];?>"></a>
		    <p><?php echo $sql[7]['name'];?></p>
		</div>
	</div>
	<div class="lx_content_bottom_right">
	     <img src="/biye/Uploads/<?php echo $sql[8]['img'];?>">
	</div>
    <div class="clear"></div>     
  </div>
  <!--尾部-->
