...
<body>
   ...
   <div class="lx_content_top">
         <div class="lx_content_top_left">
		    <p><span>知·</span>集团概况</p>
			<h6>[Group Introduction]</h6>
         </div>
         <div class="lx_content_top_right_gk">
		   <p class="gaikuang"><?php echo html_entity_decode($sql[0]['content']);?></p>
<p class="gaikuang"><?php echo html_entity_decode($sql[1]['content']);?></p>
         </div>
         <div class="clear"></div>   
  </div>
   <!--尾部-->
