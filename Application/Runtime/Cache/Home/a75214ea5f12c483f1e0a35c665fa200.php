...
<body>
   ...
   <div class="wh_content">
        <div class="wh_content_left">
	        <img  class="left_img1" src="/biye/Uploads/<?php echo $sql[0]['img'];?>">
	        <img class="left_img2" src="/biye/Uploads/<?php echo $sql[1]['img'];?>">
        </div>
		<div class="wh_content_right">
