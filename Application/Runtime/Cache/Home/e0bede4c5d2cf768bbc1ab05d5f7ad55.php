...
<div class="container2" style=" width:1000px; margin:auto;height: auto;">
        <div class="about-colm01 paddingLR100">
          <?php if(is_array($sql)): foreach($sql as $key=>$list): ?><p style="text-align:justify;background:white;vertical-align:baseline;">
                <strong style="font-size:24px;font-family:'Microsoft YaHei';line-height:1.5;"><?php echo ($list['name']); ?></strong> 
            </p>
            <p style="margin-left:0cm;text-align:justify;background:white;vertical-align:baseline;">
                <span style="font-family:'Microsoft YaHei';font-size:14px;"><?php echo html_entity_decode($list['content']);?></span> 
            </p><?php endforeach; endif; ?>  
        </div>
        <div class="core_nenglis">
        <h3>核心能力
                </h3>
        <ul class="core_list hexinnengli">
            <?php if(is_array($force)): foreach($force as $key=>$list): ?><li class="prz">
                    <a href="" class="pic img-container prz">
...
<!--内容结束-->
    <div class="footer2" style="padding:45px 40px">
