...
<body>
  ...
  <div class="lx_content1">
   ...
   <div class="sl_content_center">
        <img class="sl_content_center_left" src="/biye/Public/Home/images/sy_3.png">
		<div class="sl_content_center_right">
		    <h6>大一新生必备品列表清单—2016史上最全</h6>
		    <p>大一新生必备品列表清单—2016史上最全　　一定不能忘记：　　录取通知书；　　高考准考证；　　成绩单（有的话就带上）；　　户口本复
印件；　　身份证及正反两面复印件；（在学校也会有地方复印，但是开学肯定人很多要排队）　　一寸登记照一版；（多多益善，报名、填学
籍卡、报社团学生会、入...</p>
			<a href="#">
			    <div class="sl_botton">
