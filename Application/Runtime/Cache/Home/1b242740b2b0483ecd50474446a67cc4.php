...
<div class="containers" style=" width:1000px; margin:auto;height: auto;">
        <div class="ej-cont">
            <div class="picBoxs phoneShowp">
                <ul>
                   <?php if(is_array($sql)): foreach($sql as $key=>$value): ?><li  class="width50">
                                <a href="<?php echo U('Home/Xinwen/xinwens/id/'.$value['id']);?>"><img  src="/erongchuang/Uploads/<?php echo ($value["img"]); ?>" alt=""  width="490" height="210" />
                                <div class="shadeBox">
                                    <dl>
                                        <dt>
                                            <span><?php echo ($value["id"]); ?></span>
                                            <p style="display:none;"><?php echo date("Y-m-d",$value['times']);?></p>
                                        </dt>
                                        <dd>
                                            <h5><a href=""><?php echo ($value["name"]); ?></a></h5>
                                            <p style="display:none;"><?php echo html_entity_decode($sql['content']);?></p>
                                        </dd>
                                    </dl>
                                </div>
                                </a>
...
<div class="textlists">
        <div class="container">
            <div class="textlists-r">
                <ul>
                    <?php if(is_array($sql)): foreach($sql as $key=>$value): ?><li><a href="<?php echo U('Home/Xinwen/xinwens/id/'.$value['id']);?>"><?php echo ($value["name"]); ?></a><span><?php echo date("Y-m-d",$value['times']);?></span></li><?php endforeach; endif; ?>    
